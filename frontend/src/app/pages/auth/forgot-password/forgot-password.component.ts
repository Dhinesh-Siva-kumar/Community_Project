...
const TRANSLATIONS = {
  en: {
    ...
    formFeature1: 'Instant account lookup by username',
  ...
  ta: {
    ...
    formFeature1: 'பயனர் பெயர் மூலம் உடனடி கணக்கு தேடல்',
    ...
    dismiss: 'நிராகரி',
    identifierLabel: 'பயனர் பெயர்',
    identifierPlaceholder: 'பயனர்பெயர்',
    errIdentifierRequired: 'பயனர் பெயர் தேவை.',
    errIdentifierInvalid: 'சரியான பயனர் பெயரை உள்ளிடவும்.',
    accountFound: 'கணக்கு கிடைத்தது',
    accountNotFound: 'இந்த பயனர் பெயருடன் எந்தக் கணக்கும் இல்லை.',
    phoneLabel: 'தொலைபேசி எண்',
    phonePlaceholder: 'உள்ளூர் எண்ணை உள்ளிடவும்',
    phoneHintIdle: 'இந்தப் புலத்தைத் திறக்க, மேலே உங்கள் பயனர் பெயரை உள்ளிடவும்.',
