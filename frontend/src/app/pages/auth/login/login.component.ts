...
const TRANSLATIONS = {
  ...
  ta: {
    ...
    headlineSub: 'உங்களை மிஸ் செய்தோம்.',
    ...
    feature3: 'எப்போதும் இலவசம் — கிரெடிட் கார்டு தேவையில்லை',
    avatarRowText: 'ஆயிரக்கணக்கானோர் ஏற்கனவே இணைந்துள்ளனர்',
    cardTitle: 'மீண்டும் வரவேற்கிறோம்',
    cardSubtitle: 'தொடர உங்கள் கணக்கில் உள்நுழையவும்',
    usernameLabel: 'பயனர் பெயர்',
    usernamePlaceholder: 'பயனர் பெயர் அல்லது user@gmail.com',
