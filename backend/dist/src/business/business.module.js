...
const business_controller_js_1 = require("./business.controller.js");
...
exports.BusinessModule = BusinessModule = __decorate([
    (0, common_1.Module)({
        controllers: [business_controller_js_1.BusinessController],
        providers: [business_service_js_1.BusinessService],
        exports: [business_service_js_1.BusinessService],
    })
], BusinessModule);
