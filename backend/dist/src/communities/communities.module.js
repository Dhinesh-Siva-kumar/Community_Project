...
exports.CommunitiesModule = CommunitiesModule = __decorate([
    (0, common_1.Module)({
        controllers: [communities_controller_js_1.CommunitiesController],
        providers: [communities_service_js_1.CommunitiesService],
        exports: [communities_service_js_1.CommunitiesService],
    })
], CommunitiesModule);
