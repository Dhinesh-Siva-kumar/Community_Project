...
const MESSAGES: Record<Lang, Catalog> = {
  en: {
    ...
    'otp.whatsapp': 'Your Tamilya verification code is {{otp}}. It expires in {{minutes}} minutes.',
  ...
  ta: {
    ...
    'otp.whatsapp': 'உங்கள் தமிழியா சரிபார்ப்புக் குறியீடு {{otp}}. இது {{minutes}} நிமிடங்களில் காலாவதியாகும்.',
