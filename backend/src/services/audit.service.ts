...
export type AuditAction =
  ...
  | 'STUDENT_PROFILE_REGISTERED'
  | 'STUDENT_PROFILE_UPDATED'
  | 'STUDENT_CONNECTION_REQUEST_SENT'
  | 'STUDENT_CONNECTION_ACCEPTED'
  | 'STUDENT_CONNECTION_DECLINED'
  | 'STUDENT_SAVED_TOGGLED'
  | 'STUDENT_REPORT_FILED'
  | 'STUDENT_USER_BLOCKED'
  | 'STUDENT_VERIFICATION_APPROVED'
  | 'STUDENT_VERIFICATION_REJECTED'
  | 'STUDENT_CHAT_MESSAGE_SENT'
  | 'STUDENT_CHAT_THREAD_VIEWED_BY_ADMIN'
  | string;
